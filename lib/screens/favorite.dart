    ...
    if (_selectedCategory != 'All') {
      for (int i = 0; i < urlProvider.urls.length; i++) {
        if (urlProvider.urls[i].category == _selectedCategory &&
            urlProvider.urls[i].favorite == true) {
          length++;
        }
      }
    }
                    ...
                    Opacity(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            '${_selectedCategory != 'All' ? calculateBookmarkLength() : calculateFavLength(urlData)}',
                  ...
                  : Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          if (urlData.urls[index].favorite == false) {
                            return const SizedBox();
                          } else {
                            if (_selectedCategory == 'All') {
                              return favItems(urlData, index);
